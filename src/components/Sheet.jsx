...
export default function Sheet({ open, onClose, title, children, footer }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div
        ref={sheetRef}
        className={`${dragging ? '' : 'sheet-up'} relative w-full max-w-md bg-zinc-950 border-t border-white/10 rounded-t-3xl max-h-[85dvh] landscape:max-h-[90vh] flex flex-col cursor-grab overflow-hidden`}
        style={{
      ...
      >
        <div
          ref={scrollRef}
          className="overflow-y-auto px-6 pt-5 pb-8 landscape:pt-3 landscape:pb-5"
          style={footer ? undefined : { paddingBottom: 'calc(env(safe-area-inset-bottom) + 2rem)' }}
        >
          <div
        ...
        {footer && (
          <div
            className="shrink-0 border-t border-white/10 px-6 pt-3 landscape:pt-2 bg-zinc-950"
